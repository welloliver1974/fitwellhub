-- ==============================================================================
-- FitWell Hub: Liberar RLS para Hermes Agent (Telegram) em Refeições e Água
-- Permite que o Hermes registre refeições, alimentos e água no diário
...
-- 2. TABELA MEAL_ITEMS (Alimentos da Refeição)
...
-- 3. TABELA WATER_LOGS (Registro de Hidratação / Água)
...
-- 6. TABELAS DE TREINO (Check-in e criação de treinos via Telegram)
